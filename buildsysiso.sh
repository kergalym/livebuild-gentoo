...
ARCH="i386"
LOOP_IMAGE="/media/WDGR/genlive.img"
ISO_NAME="Gentoo_Linux_KDE_i386.iso"
...
start() {
   ...
   #cp scripts/kernel-config $BUILDROOT/usr/src/linux/.config /usr/share/genkernel/arch/x86_64/kernel-config
   ...
   cp scripts/installation-helper.sh $BUILDROOT/usr/bin/installer
